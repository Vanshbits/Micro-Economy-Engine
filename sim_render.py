...
ax.set_ylim(-1, 12)
ax.set_title(
    "Micro Economy: Real-Time Engine",
    color="white",
    fontsize=22,
    pad=20,
    style="italic",
...
scatter = ax.scatter(
    [], [], s=450, alpha=0.9, zorder=2, edgecolors="white", linewidths=1.5
)
time_text = ax.text(
    0.02,
    0.95,
...
agent_labels = [
    ...
    for _ in range(len(unique_agents))
]
...
anim = animation.FuncAnimation(
    fig, update, frames=df["HOUR"].unique(), interval=400, blit=True
)
